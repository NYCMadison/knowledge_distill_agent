# microgridresources_org - news_transactive-energy-tariff

**来源**：https://microgridresources.org/news/transactive-energy-tariffs-provide-a-pathway-to-market-for-microgrids/
**日期**：20260311
...
By shaping load around the availability of intermittent resources, the tariff reduces both peak demand and ramping requirements and allows flexible grid resources to operate more nearly at resource peak efficiency.
By managing the system load at all times, not only peak times, it provides increased beneficial electrification capacity through better infrastructure utilization and avoids massive distribution infrastructure investments.
By reducing stress on generation, transmission, and distribution equipment it reduces operation and maintenance cost.
By using lower cost Customer Resources, by avoiding line losses, and by avoiding use of the highest priced peaking resources it reduces system wide energy price.
...
—
Keep up with all that MRC is doing to support DER integration and microgrid adoption across the country by subscribing to our newsletter here.
Close modal
